...
write_csv(abundance, file.path('standard_worklow/combined_data', 'abundance_with_infection_data.csv'))
...
# Save new metadata
write_csv(metadata, file.path('standard_workflow/data', 'metadata_with_infection_data.csv'))
```
