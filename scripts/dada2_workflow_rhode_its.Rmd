...
### Remove Ns from any reads before beginning DADA2 workflow. I did this for the rps10 analysis (which I ran first) so I'll just reference these new filtered reads
```{r remove Ns}
