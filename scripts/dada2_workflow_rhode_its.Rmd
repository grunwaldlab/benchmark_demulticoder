...
### Workflow is similar to what is described in the rps10 tutorial in DADA2 documentation, but since amplicons were pooled, I needed to first demultiplex rps10 reads within sample, or else rps10 reads will still be included in all downstream steps
