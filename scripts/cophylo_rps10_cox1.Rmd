...
### Read in the data
```{r, read in trees}
cox1<-ape::read.tree("rps10_cox1_phylogeny/data/cox1_db_mafft_unique_gp1000.fasta.treefile")
#cox1<-midpoint(cox1)
...
pdf("rps10_cox1_phylogeny/figures/figure_cox_vs_rps10_unique_auto_rotatemultitrue_midpoint_black.pdf", width = 8.5, height = 11, useDingbats = FALSE)
