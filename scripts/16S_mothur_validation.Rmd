...
tax_matrix<-read.csv("~/demulticoder_benchmarking/mothur_16S_sop/outputs/final_asv_abundance_matrix_r16S.csv")
...
mock.ref <- dada2::getSequences(file.path("~/demulticoder_benchmarking/mothur_16S_sop/data", "HMP_MOCK.v35.fasta"))
...
alpha_diversity_16S_sop<-phyloseq::plot_richness(objs$phyloseq_r16S, x="Day", measures=c("Shannon", "Simpson"), color="When")

#Save plot as pdf
pdf("alpha_diversity_16S_sop.pdf", width=6, height=6)
```
